...
namespace BetterHealthCareToolbar {
    public static class Patcher {
        private const string HarmonyId = "t1a2l.BetterHealthCareToolbar";
        ...
        public static void PatchAll() {
            ...
            UnityEngine.Debug.Log("Better HealthCare Toolbar: Patching...");

            patched = true;

            // Apply your patches here!
            // Harmony.DEBUG = true;
            var harmony = new Harmony("t1a2l.BetterHealthCareToolbar");
        ...
        public static void UnpatchAll() {
            ...
            UnityEngine.Debug.Log("Better HealthCare Toolbar: Reverted...");
        }
    }
